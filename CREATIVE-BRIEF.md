...
| 4 | Camera-Ready setup | `CameraReady.tsx` | 4:5 portrait (mobile) / 4:3 landscape (desktop), same image | 2400×2400px source, or two crops: 1600×2000 (4:5) + 2000×1500 (4:3) | JPG/WebP, or MP4 (H.264) if it's a video clip, the component already supports both. | RGB lighting, LED mirror, spotlight stage, tripod corner. |
...
| # | Asset | Format | Notes |
|---|-------|--------|-------|
| 7 | Logo, primary lockup | SVG, transparent background | Design at your lockup's real proportions (a horizontal wordmark is likely ~4:1 to 3:1); must stay legible at ~36px tall, its actual header size. Used in header/footer wordmark treatment. |
| 8 | Logo, icon/mark only | SVG primary + PNG 512×512 fallback, transparent | Square version for favicon and any icon-only placement. |
...
| 11 | OG/social share image | 1200×630px (1.91:1), JPG or PNG | Currently an auto-generated wordmark placeholder (`public/og-image.svg`); replace once real branding exists. |
