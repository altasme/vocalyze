...
export function Placeholder({ label, className = '', aspect = 'aspect-[4/3]' }: PlaceholderProps) {
  return (
    <div
      role="img"
      aria-label={`Placeholder: ${label} photo coming soon`}
      className={`${aspect} ${className} flex flex-col items-center justify-center gap-2 rounded-2xl border border-dashed border-border-subtle bg-bg-surface/60 p-4 text-center`}
    >
